...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("name", sa.String(), nullable=True),
        sa.Column(
            "type", sa.Enum("branch", "department", "founder", name="roomtype"), nullable=True
        ),
        sa.Column("is_active", sa.Boolean(), nullable=True),
        sa.Column("created_at", sa.DateTime(), nullable=True),
        sa.PrimaryKeyConstraint("id"),
    ...
    op.create_index(
        op.f("ix_room_members_employee_id"), "room_members", ["employee_id"], unique=False
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum("open", "in_progress", "approved", "resolved", name="ticketstatus"),
            nullable=True,
        ),
        sa.Column(
            "priority", sa.Enum("low", "medium", "high", name="ticketpriority"), nullable=True
        ),
        sa.Column("is_active", sa.Boolean(), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column(
            "type",
            sa.Enum("comment", "approval", "status_update", name="messagetype"),
            nullable=True,
        ),
        sa.Column("created_at", sa.DateTime(), nullable=True),
        sa.ForeignKeyConstraint(
